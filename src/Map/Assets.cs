    ...
    public class Assets
    {
        ...
        public Assets(Ui ui)
        {
            ...
            foreach(var asset in assets) {
                ...
                models.Add($"asset_{asset}", ModelRenderer.Load(asset));
            }
        }
        ...
        public void Render(Camera camera, Light light, TerrainRenderer terrain)
        {
            ...
            {
                modelRenderer.Render(camera, light, asset.Model, new Vector3(asset.Position.X, (float)terrain.GetElevationAtPoint(asset.Position), asset.Position.Z));
            }
        }
    }
}